...
$userQuery=$connection->UpdateUser($conobj,"buyer_reg",$Name,$Email,$_SESSION['User'],$Phone,$Address,$Var_Gender);
if($userQuery==TRUE)
{
...
if (isset($_POST['Delete'])) 
{
    ...
    $connection = new DatabaseConnection();
    $conobj=$connection->OpenCon();
    $userQuery=$connection->DeleteUser($conobj,"buyer_reg",$User);
if($userQuery==TRUE)
{
